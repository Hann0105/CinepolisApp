...
{
    public partial class GestionarSupervisores : System.Web.UI.Page
    {
        ...
        public void displayData()
        {
            ...
            cmd.CommandText = "Select *, CASE WHEN estatus = '1' THEN 'ACTIVO' WHEN estatus = '2' THEN 'INACTIVO' END as estatus_bueno from Usuarios where tipoUsuario = 2;";
            cmd.ExecuteNonQuery();
        ...
        protected void grdInspectores_RowDeleting(object sender, GridViewDeleteEventArgs e)
        {
            try
            {
                ...
                {
                    con.Open();
                    string query = "UPDATE Usuarios set estatus = 2 WHERE idUsuario = @id";
